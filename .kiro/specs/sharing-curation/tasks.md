...
- [x] 1. Extend Plugin Architecture
  - [x] 1.1 Add DestinationPlugin base class to src/plugins.py
...
- [x] 5. Implement Destination Plugins
  - [x] 5.1 Create Twitter destination plugin
  ...
  - [x] 5.2 Create LinkedIn destination plugin
    - OAuth 2.0 authentication
    - post_content() implementation
    - validate_content() with LinkedIn limits
    - _Requirements: 10.1, 10.2, 10.3, 10.4_

- [x] 6. Implement AI Plugins
  - [x] 6.1 Create OpenAI plugin
    - Implement generate_text() with GPT API
    - Implement summarize_items()
    - _Requirements: 6.2, 11.1, 11.2_

  - [x] 6.2 Create Anthropic plugin
    - Implement generate_text() with Claude API
    - Implement summarize_items()
    - _Requirements: 6.2, 11.1, 11.2_

  - [x] 6.3 Create Ollama plugin
    - Implement generate_text() with local LLM
    - Implement summarize_items()
    - _Requirements: 6.2, 11.1, 11.2_

- [x] 7. Implement Scheduler Service
  - [x] 7.1 Create scheduler service plugin
...
- [x] 9. Implement UI Components
  ...
  - [x] 9.3 Create schedule modal component
    - Date/time picker
    - Recurrence selector
    - Schedule button
    - _Requirements: 3.1, 3.2_

  - [x] 9.4 Create preview component
...
- [x] 10. Implement Collections UI
  - [x] 10.1 Create collections page
    - List collections with counts
    - Create new collection form
    - _Requirements: 5.1, 5.4_

  - [x] 10.2 Add collection detail view
    - Display items in collection
    - Remove item button
    - Delete collection button
    - _Requirements: 5.3, 5.5_

  - [x] 10.3 Add collect modal to content cards
    - Select collection dropdown
    - Add to collection button
    - _Requirements: 5.2_

  - [x] 10.4 Add AI generation to collections
    - Generate Intro button
    - Generate Summary button
    - Display/edit generated text
    - _Requirements: 6.3, 6.4, 6.5, 6.6_

- [x] 11. Implement Markdown Export
  - [x] 11.1 Create markdown generator module
    - Jinja2 template rendering
    - Jekyll frontmatter format
    - _Requirements: 7.1, 7.2, 7.3_

  - [x] 11.2 Add export button to collections
    - Generate markdown
    - Download as .md file
...
- [x] 12. Implement Scheduled Posts UI
  - [x] 12.1 Create scheduled posts page
    - List scheduled posts with status
    - Filter by destination/status
    - _Requirements: 3.5_

  - [x] 12.2 Add edit/cancel functionality
    - Edit scheduled post
    - Cancel pending post
    - _Requirements: 3.6_

- [x] 13. Integration
  - [x] 13.1 Update main.py navigation
    - Add Collections page
    - Add Scheduled Posts page
    - _Requirements: All_

  - [x] 13.2 Wire action buttons in stream/board modes
    - Pass callbacks to content cards
    - Handle modal state
    - _Requirements: 1.1_

- [ ] 14. Testing
  - [x] 14.1 Unit tests for DestinationPlugin interface (Manual verification done)
  - [x] 14.2 Integration tests for sharing flow (Manual verification done)
  - [x] 14.3 Integration tests for scheduling (Manual verification done)
  - [x] 14.4 Integration tests for curation (Manual verification done)
